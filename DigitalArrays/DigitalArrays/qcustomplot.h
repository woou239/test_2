...
#define COUNT50000_TIME1 0.00002 
...
public:
  ...
  */
  ...
  void addData(double* data, uint32_t size, double coefficient, bool alreadySorted = true);
  void addData(double* key, double* value, uint32_t size, bool alreadySorted = true);
