...
constexpr auto qt_meta_stringdata_CLASSIndicatorLightENDCLASS = QtMocHelpers::stringData(
    "IndicatorLight"
);
...
constexpr auto qt_meta_stringdata_CLASSGetDataThreadENDCLASS = QtMocHelpers::stringData(
    "GetDataThread",
    "trans_ringbuffer",
    "",
    "lpParam",
...
constexpr auto qt_meta_stringdata_CLASSDoUpdateThreadENDCLASS = QtMocHelpers::stringData(
    "DoUpdateThread",
    "update_customPlot",
    "",
    "double**",
